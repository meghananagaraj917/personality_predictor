...
print("Reading data from Training Dataset completed")
...
print("Trying to calculate the accuracy of the trained model") 

print("Accuracy score of the Logistic Regression Model :", round(accuracy_score(Y_test,y_pred)*100, 2), "%")
